 ...
 * apl View
 */
class aplViewImportV2Articles extends JView
{
	/**
	...
	function display($tpl = null) 
	{
		...
		echo var_dump($this);
		echo ("<pre></pre>");
		echo var_dump($this->_models['importv2articles']->_db->getErrorNum());
		die();*/
		if ($this->_models['importv2articles']->_db->getErrorNum() > 0) { 
			$items = "";
		} else {
			$items = $this->get('Items');			// => admin/models/importV2Articles.php
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::custom('importV2Articles.import','import','import',JText::_('COM_APL_IMPORT'), true);
