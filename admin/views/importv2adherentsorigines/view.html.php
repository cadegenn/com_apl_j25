 ...
 * apl View
 */
class aplViewImportV2AdherentsOrigines extends JView
{
	/**
	...
	{
		if ($this->_models['importv2adherentsorigines']->_db->getErrorNum() > 0) { 
			$items = "";
		} else {
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_APL').' : '.JText::_('COM_APL_SUBMENU_IMPORT_ADHERENTSORIGINES'), 'apl');
		...
		JToolBarHelper::custom('importV2AdherentsOrigines.import','import','import',JText::_('COM_APL_IMPORT'), true);
