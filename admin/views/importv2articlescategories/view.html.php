 ...
 * apl View
 */
class aplViewImportV2ArticlesCategories extends JView
{
	/**
	...
	function display($tpl = null) 
	{
		...
		echo var_dump($this);
		echo ("<pre></pre>");
		echo var_dump($this->_models['importv2articlesCategories']->_db->getErrorNum());
		die();*/
		if ($this->_models['importv2articlesCategories']->_db->getErrorNum() > 0) { 
			$items = "";
		} else {
			$items = $this->get('Items');			// => admin/models/importV2ArticlesCategories.php
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::custom('importV2ArticlesCategories.import','import','import',JText::_('COM_APL_IMPORT'), true);
