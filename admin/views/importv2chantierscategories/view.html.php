 ...
 * apl View
 */
class aplViewImportV2ChantiersCategories extends JView
{
	/**
	...
	{
		if ($this->_models['importv2chantierscategories']->_db->getErrorNum() > 0) { 
			$items = "";
		} else {
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_APL').' : '.JText::_('COM_APL_SUBMENU_IMPORT_CHANTIERSCATEGORIES'), 'apl');
		...
		JToolBarHelper::custom('importV2ChantiersCategories.import','import','import',JText::_('COM_APL_IMPORT'), true);
